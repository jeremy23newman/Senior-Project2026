...
/**
*/
class BasicFilterAudioProcessorEditor  : public juce::AudioProcessorEditor
{
public:
    BasicFilterAudioProcessorEditor (BasicFilterAudioProcessor&, juce::AudioProcessorValueTreeState& vts);
    ~BasicFilterAudioProcessorEditor() override;
...
private:
    ...
    BasicFilterAudioProcessor& audioProcessor;
