...
- **Logic Pro** – Plugin host for testing (AU format)
- **Xcode** – macOS build environment
- **Projucer** – Project configuration

### Individual Plugins
Each effect will be implemented as a standalone plugin:
...
### Phase 1: Research and Basic Implementation (Weeks 1–7)
- Learn JUCE framework fundamentals
